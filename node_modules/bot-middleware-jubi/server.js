...
module.exports.Server = function (modal, initCallback) {
    ...
    (async function () {
        try {
            ...
            if (cluster) {
                let subSocket = redis.createClient(modal.redis.port,modal.redis.host,{ auth_pass:modal.redis.password});
                let pubSocket = redis.createClient(modal.redis.port,modal.redis.host,{ auth_pass:modal.redis.password});
                ...
                io.adapter(socketRedis({ pubClient: pubSocket, subClient: subSocket }));
            }
            else {
