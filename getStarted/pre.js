...
function start(model){
    ...
    try{
        ...
        model.reply={
            ...
            text : "Hello "+greet+" let 2019 be all about getting your financial priorities right. If you are not an existing investor click here - https://www.fundzbazar.com/signup to register. If you are an existing investor you can do the following right now!",
            next : {
                data : [
                    {
                        data : 'Invest Now',
