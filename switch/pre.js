...
function amount(model){
	return new Promise(function(resolve, reject){
		...
		model.reply={
			type:"text",
            text:"Tell me the amount you want to invest, it should be greater or equal to Rs "+model.tags.switchSchemeObj["MinSwitchOutAmount"]+" and less than or equal to Rs "+model.tags.switchSchemeObj["AvailableAmt"]
		}
		resolve(model)
	})
}
